...
import com.guideal.guidclient.scripting.api.VisibilityCheck;
import com.guideal.guidclient.scripting.compiler.operations.BinaryOperation;
import com.guideal.guidclient.scripting.compiler.operations.ImplicitCast;
import com.guideal.guidclient.scripting.compiler.operations.UnaryOperation;
import com.guideal.guidclient.scripting.compiler.types.*;
import com.guideal.guidclient.scripting.generated.*;
...
public class ScriptingLanguageCompiler {
    ...
    public Runnable compile(String program) throws ParseException, ScriptCompileException {
        ...
        String name = "com/guideal/scripting/dynamic/DynamicClass_" + counter.incrementAndGet();
