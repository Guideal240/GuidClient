...
import com.guideal.guidclient.mixins.common.accessors.HolderReferenceAccessor;
import com.guideal.guidclient.webui.EntityInfoApi;
...
public class EntityUtils {
    ...
    private static synchronized void loadEntityClasses() {
        ...
        EntityType playerEntityType = com.guideal.guidclient.common.Registries.ENTITY_TYPES.getValue(new ResourceLocation("minecraft:player"));
        ...
        com.guideal.guidclient.common.Registries.ENTITY_TYPES.getValues().stream().map(et -> {
            ...
            try {
                ...
                if (entity == null) {
                    ...
                    EntityInfo info = new EntityInfo(entity.getClass(), com.guideal.guidclient.common.Registries.ENTITY_TYPES.getKey(et).toString());
                    set.add(info);
                    return info;
                }
            }
